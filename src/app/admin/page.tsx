  ...
  const handleEditUser = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updateData: UpdateUserData = {
        role: editUserRole,
        is_active: true, // Ensure user is active when edited
      };
      
      // Only add fields that have values
      if (profileImageUrl) updateData.profile_image = profileImageUrl;
      if (editUserGithub) updateData.github_handle = editUserGithub;
      if (editUserLinkedin) updateData.linkedin_profile_link = editUserLinkedin;
      if (editUserFacebook) updateData.facebook_handle = editUserFacebook;
      if (editUserInstagram) updateData.instagram_handle = editUserInstagram;
      if (editUserMemberSince) updateData.member_since = Timestamp.fromDate(new Date(editUserMemberSince));
